class Level {
  ...
  Level(int[][] grid, int difficulty, String[] path, int pathLength, int numberOfResets, ArrayList<PVector> snowflakes) {
    ...
    flagSprite = loadImage("sprites/flag.png");
    waterSprite = loadImage("sprites/water.png");
    snowflakeSprite = loadImage("sprites/snowflake.png");
    resetButton = loadImage("sprites/reset.png");
    resetHover = loadImage("sprites/reset-hover.png");
    oneStar = loadImage("sprites/1-star.png");
    twoStars = loadImage("sprites/2-stars.png");
    threeStars = loadImage("sprites/3-stars.png");
    snowmanHighRes = loadImage("sprites/player-high-res.png");
    
    // load wall sprites
    wallSprites.put("E", loadImage("sprites/walls/E.jpg"));
    wallSprites.put("N", loadImage("sprites/walls/N.jpg"));
    wallSprites.put("N-E", loadImage("sprites/walls/N-E.jpg"));
    wallSprites.put("N-S", loadImage("sprites/walls/N-S.jpg"));
    wallSprites.put("N-S-E", loadImage("sprites/walls/N-S-E.jpg"));
    wallSprites.put("N-S-W", loadImage("sprites/walls/N-S-W.jpg"));
    wallSprites.put("N-S-W-E", loadImage("sprites/walls/N-S-W-E.jpg"));
    wallSprites.put("N-W", loadImage("sprites/walls/N-W.jpg"));
    wallSprites.put("N-W-E", loadImage("sprites/walls/N-W-E.jpg"));
    wallSprites.put("S", loadImage("sprites/walls/S.jpg"));
    wallSprites.put("S-E", loadImage("sprites/walls/S-E.jpg"));
    wallSprites.put("single", loadImage("sprites/walls/single.jpg"));
    wallSprites.put("W", loadImage("sprites/walls/W.jpg"));
    wallSprites.put("W-E", loadImage("sprites/walls/W-E.jpg"));
    wallSprites.put("S-W-E", loadImage("sprites/walls/S-W-E.jpg"));
    wallSprites.put("S-W", loadImage("sprites/walls/S-W.jpg"));
    
    wallSprites.put("E-edge", loadImage("sprites/walls/E-edge.jpg"));
    wallSprites.put("N-edge", loadImage("sprites/walls/N-edge.jpg"));
    wallSprites.put("S-edge", loadImage("sprites/walls/S-edge.jpg"));
    wallSprites.put("W-edge", loadImage("sprites/walls/W-edge.jpg"));
    wallSprites.put("N-E-edge", loadImage("sprites/walls/N-E-edge.jpg"));
    wallSprites.put("N-W-edge", loadImage("sprites/walls/N-W-edge.jpg"));
    wallSprites.put("S-E-edge", loadImage("sprites/walls/S-E-edge.jpg"));
    wallSprites.put("S-W-edge", loadImage("sprites/walls/S-W-edge.jpg"));
  }
